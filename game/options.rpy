...
define config.name = _("溯魂残谱_demo")
...
define config.main_menu_music = "bgm/0.main_menu_bg.mp3"
...
define config.save_directory = "gal_demo-1752933031"
