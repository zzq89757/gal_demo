...
## 标题菜单和游戏菜单使用的图像。
# define gui.main_menu_background = "gui/cover_1920x.jpg"
define gui.main_menu_background = Transform("gui/cover_1920x.jpg", size=(config.screen_width, config.screen_height))
